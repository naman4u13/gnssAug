...
import com.gnssAug.Android.constants.Constant;
...
public class INSfusion {
	...
	private static void updateTotalState(State x, HashMap<AndroidSensor, IMUsensor> imuSensor, double tau) {
		...
		double[] _omega_n_ie = new double[] { Constant.earthAngularRate * Math.cos(lat), 0,
				-Constant.earthAngularRate * Math.sin(lat) };
