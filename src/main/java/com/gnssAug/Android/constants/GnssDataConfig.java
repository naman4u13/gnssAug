...
public class GnssDataConfig {
	...
	final public static double pseudorange_priorVarOfUnitW =  1;//Math.pow(2.47, 2);
	final public static double doppler_priorVarOfUnitW =1e16;//Math.pow(0.0616, 2);
	final public static double tdcp_priorVarOfUnitW = 0.001;//0.0006;
	final public static double phase_priorVarOfUnitW = 1e16;//0.0006;
