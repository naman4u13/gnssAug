...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		case 1:
			...
			String basePath =  "C:\\Users\\naman.agarwal\\Documents\\GNSS\\Google Decimeter Challenge\\decimeter\\train\\2021-04-28-US-SJC-1\\SamsungS20Ultra";
			//"C:\\D drive\\Study\\Google Decimeter Challenge\\decimeter\\train\\2021-04-29-US-MTV-1\\Pixel4";
			
			Set<String> discardSet = true?Set.of("C23"):Set.of("C11","G12","G2");//C33
			...
			Android.posEstimate(true, 0, 0,10, obsvCodeList, derived_csv_path, gnss_log_path, GTcsv, bias_path,
