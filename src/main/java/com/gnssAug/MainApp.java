...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		case 1:
			...
			Set<String> discardSet = false?Set.of("C33","G29","G31"):Set.of("C11","G12","G2");
			...
			Android.posEstimate(true, 0.5, 0,10, obsvCodeList, derived_csv_path, gnss_log_path, GTcsv, bias_path,
