 ...
 * <a href=
 * "http://www.ngdc.noaa.gov/geomag/WMM/DoDWMM.shtml">http://www.ngdc.noaa.gov/geomag/WMM/DoDWMM.shtml</a>.
...
public class GeomagneticField {
	...
	static private final float[][] G_COEFF = new float[][] { { 0.0f }, { -29404.5f, -1450.7f },
			{ -2500.0f, 2982.0f, 1676.8f }, { 1363.9f, -2381.0f, 1236.2f, 525.7f },
			{ 903.1f, 809.4f, 86.2f, -309.4f, 47.9f }, { -234.4f, 363.1f, 187.8f, -140.7f, -151.2f, 13.7f },
	...
	static private final float[][] H_COEFF = new float[][] { { 0.0f }, { 0.0f, 4652.9f }, { 0.0f, -2991.6f, -734.8f },
			{ 0.0f, -82.2f, 241.8f, -542.9f }, { 0.0f, 282.0f, -158.4f, 199.8f, -350.1f },
			{ 0.0f, 47.7f, 208.4f, -121.3f, 32.2f, 99.1f }, { 0.0f, -19.1f, 25.0f, 52.7f, -64.4f, 9.0f, 68.1f },
	...
	static private final float[][] DELTA_G = new float[][] { { 0.0f }, { 6.7f, 7.7f }, { -11.5f, -7.1f, -2.2f },
			{ 2.8f, -6.2f, 3.4f, -12.2f }, { -1.1f, -1.6f, -6.0f, 5.4f, -5.5f },
			{ -0.3f, 0.6f, -0.7f, 0.1f, 1.2f, 1.0f }, { -0.6f, -0.4f, 0.5f, 1.4f, -1.4f, 0.0f, 0.8f },
	...
	static private final float[][] DELTA_H = new float[][] { { 0.0f }, { 0.0f, -25.1f }, { 0.0f, -30.2f, -23.9f },
			{ 0.0f, 5.7f, -1.0f, 1.1f }, { 0.0f, 0.2f, 6.9f, 3.7f, -5.6f }, { 0.0f, 0.1f, 2.5f, -0.9f, 3.0f, 0.5f },
			{ 0.0f, 0.1f, -1.8f, -1.4f, 0.9f, 0.1f, 1.0f }, { 0.0f, 0.5f, 0.6f, -0.7f, -0.2f, -1.2f, 0.2f, 0.3f },
	...
	static private final long BASE_TIME = new Calendar.Builder().setTimeZone(TimeZone.getTimeZone("UTC"))
			.setDate(2020, Calendar.JANUARY, 1).build().getTimeInMillis();
	 ...
	 *
	 * @param gdLatitudeDeg  Latitude in WGS84 geodetic coordinates -- positive is
	 *                       east.
	 * @param gdLongitudeDeg Longitude in WGS84 geodetic coordinates -- positive is
	 *                       north.
	 * @param altitudeMeters Altitude in WGS84 geodetic coordinates, in meters.
	 * @param timeMillis     Time at which to evaluate the declination, in
	 *                       milliseconds since January 1, 1970. (approximate is
	 *                       fine -- the declination changes very slowly).
	 */
	 ...
	 *         from true north, in degrees (i.e. positive means the magnetic field
	 *         is rotated east that much from true north).
	 */
	...
	/**
	 * @return The inclination of the magnetic field in degrees -- positive means
	 *         the magnetic field is rotated downwards.
	 */
	 ...
	 * @return Geocentric latitude (i.e. angle between closest point on the equator
	 *         and this point, at the center of the earth.
	 */
	private void computeGeocentricCoordinates(float gdLatitudeDeg, float gdLongitudeDeg, float altitudeMeters) {
		...
		float radSq = altitudeKm * altitudeKm + 2 * altitudeKm * (float) Math.sqrt(a2 * clat * clat + b2 * slat * slat)
