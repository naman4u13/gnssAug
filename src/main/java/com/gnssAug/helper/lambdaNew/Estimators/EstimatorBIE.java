...
public class EstimatorBIE {
     ...
     * 
     * Computes the real-valued solution given by a Best Integer 
     ...
     * an approximation to the infinite summation.
     * 
     ...
     */
    public static EstimatorBIEResult estimatorBIE(SimpleMatrix aHat, SimpleMatrix LMat, double[] dVec, Double chi2, Integer nMax) {
        ...
        for (int zNow = zMin; zNow <= zMax; zNow++) {
            ...
            if (nn > 1) {
                ...
                EstimatorBIENestedResult nestedResult = estimatorBIE_nested(zCond, LMat.extractMatrix(0, nn - 1, 0, nn - 1), Arrays.copyOfRange(dVec, 0, nn - 1), nn - 1, chi2New, nInt, zVect, nMaxValue);
     ...
     */
    private static EstimatorBIENestedResult estimatorBIE_nested(SimpleMatrix aHat, SimpleMatrix LMat, double[] dVec, int kk, double chi2, int nInt, SimpleMatrix zVect, double nMax) {
        // Initialize main variables
        ...
        for (int zNow = zMin; zNow <= zMax; zNow++) {
            ...
            if (kk > 1) {
                ...
                EstimatorBIENestedResult nestedResult = estimatorBIE_nested(zCond, LMat.extractMatrix(0, kk - 1, 0, kk - 1), Arrays.copyOfRange(dVec, 0, kk - 1), kk - 1, chi2New, nInt, zVect, nMax);
     ...
     */
    public static class EstimatorBIEResult {
     ...
     */
    private static class EstimatorBIENestedResult {
